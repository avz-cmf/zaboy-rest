...
class EavAbstractFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $requestedName = StoreCatalog::PROP_LINKED_URL_TABLE_NAME . SuperEntity::LEFT_JOIN . StoreCatalog::PRODUCT_TABLE_NAME;
        $result = $this->container->has($requestedName);
        $this->assertFalse($result);

        $requestedName = StoreCatalog::PRODUCT_TABLE_NAME . SuperEntity::LEFT_JOIN . StoreCatalog::PRODUCT_TABLE_NAME;
        $result = $this->container->has($requestedName);
        $this->assertTrue($result);

        $requestedName = StoreCatalog::PRODUCT_TABLE_NAME . SuperEntity::LEFT_JOIN . '1' . StoreCatalog::PRODUCT_TABLE_NAME;
        $result = $this->container->has($requestedName);
        $this->assertFalse($result);
    }
